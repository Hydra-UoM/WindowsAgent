...
int _kCommandTypeValues[] = {
  CommandType::USER_DEFINED_COMMAND,
  CommandType::FULL_INFO_COMMAND,
  CommandType::CRITICAL_EVENTS_COMMAND,
  CommandType::INSTANT_EVENTS_COMMAND
};
const char* _kCommandTypeNames[] = {
  "USER_DEFINED_COMMAND",
  "FULL_INFO_COMMAND",
  "CRITICAL_EVENTS_COMMAND",
  "INSTANT_EVENTS_COMMAND"
};
const std::map<int, const char*> _CommandType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kCommandTypeValues, _kCommandTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
void Device::__set_commandType(const CommandType::type val) {
  this->commandType = val;
}

const char* Device::ascii_fingerprint = "01C9456ECDC9B13B3949B013F9E488D4";
const uint8_t Device::binary_fingerprint[16] = {0x01,0xC9,0x45,0x6E,0xCD,0xC9,0xB1,0x3B,0x39,0x49,0xB0,0x13,0xF9,0xE4,0x88,0xD4};
    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->commandType = (CommandType::type)ecast0;
...
uint32_t Device::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("commandType", ::apache::thrift::protocol::T_I32, 6);
...
Device::Device(const Device& other1) {
  deviceId = other1.deviceId;
  IPAddress = other1.IPAddress;
  port = other1.port;
  type = other1.type;
  group = other1.group;
  commandType = other1.commandType;
  __isset = other1.__isset;
}
Device& Device::operator=(const Device& other2) {
  deviceId = other2.deviceId;
  IPAddress = other2.IPAddress;
  port = other2.port;
  type = other2.type;
  group = other2.group;
  commandType = other2.commandType;
...
const char* ThriftAgentProcessInfo::ascii_fingerprint = "D7B12137D03A7E62E08F64DAEDA995A6";
const uint8_t ThriftAgentProcessInfo::binary_fingerprint[16] = {0xD7,0xB1,0x21,0x37,0xD0,0x3A,0x7E,0x62,0xE0,0x8F,0x64,0xDA,0xED,0xA9,0x95,0xA6};
...
ThriftAgentProcessInfo::ThriftAgentProcessInfo(const ThriftAgentProcessInfo& other3) {
  name = other3.name;
...
ThriftAgentProcessInfo& ThriftAgentProcessInfo::operator=(const ThriftAgentProcessInfo& other4) {
  name = other4.name;
  packageName = other4.packageName;
  ramUsage = other4.ramUsage;
  cpuUsage = other4.cpuUsage;
  sentData = other4.sentData;
  receiveData = other4.receiveData;
  pid = other4.pid;
  type = other4.type;
  mac = other4.mac;
...
const char* myUserAccountDetailsStruct::ascii_fingerprint = "14A937C7B20A7673F42A4C3F91819A82";
const uint8_t myUserAccountDetailsStruct::binary_fingerprint[16] = {0x14,0xA9,0x37,0xC7,0xB2,0x0A,0x76,0x73,0xF4,0x2A,0x4C,0x3F,0x91,0x81,0x9A,0x82};
...
myUserAccountDetailsStruct::myUserAccountDetailsStruct(const myUserAccountDetailsStruct& other5) {
...
myUserAccountDetailsStruct& myUserAccountDetailsStruct::operator=(const myUserAccountDetailsStruct& other6) {
  computerName = other6.computerName;
  usri4_name = other6.usri4_name;
  usri4_password_age = other6.usri4_password_age;
  usri4_priv = other6.usri4_priv;
  usri4_flags = other6.usri4_flags;
  usri4_usr_comment = other6.usri4_usr_comment;
  usri4_parms = other6.usri4_parms;
  usri4_last_logon = other6.usri4_last_logon;
  usri4_last_logoff = other6.usri4_last_logoff;
  usri4_acct_expires = other6.usri4_acct_expires;
  usri4_max_storage = other6.usri4_max_storage;
  usri4_units_per_week = other6.usri4_units_per_week;
  usri4_logon_hours = other6.usri4_logon_hours;
  usri4_bad_pw_count = other6.usri4_bad_pw_count;
  usri4_num_logons = other6.usri4_num_logons;
  usri4_country_code = other6.usri4_country_code;
  usri4_code_page = other6.usri4_code_page;
  usri4_primary_group_id = other6.usri4_primary_group_id;
  usri4_profile = other6.usri4_profile;
  usri4_password_expired = other6.usri4_password_expired;
  usri4_auth_flags = other6.usri4_auth_flags;
...
myRuleInformation::myRuleInformation(const myRuleInformation& other7) {
  ID = other7.ID;
  Name = other7.Name;
  __isset = other7.__isset;
}
myRuleInformation& myRuleInformation::operator=(const myRuleInformation& other8) {
  ID = other8.ID;
  Name = other8.Name;
...
mySubject::mySubject(const mySubject& other9) {
...
mySubject& mySubject::operator=(const mySubject& other10) {
  Security_ID = other10.Security_ID;
  Account_Name = other10.Account_Name;
  Account_Domain = other10.Account_Domain;
  Logon_ID = other10.Logon_ID;
...
myProviderInformation::myProviderInformation(const myProviderInformation& other11) {
  Provider_ID = other11.Provider_ID;
  Provider_Name = other11.Provider_Name;
  __isset = other11.__isset;
}
myProviderInformation& myProviderInformation::operator=(const myProviderInformation& other12) {
  Provider_ID = other12.Provider_ID;
  Provider_Name = other12.Provider_Name;
...
myObject::myObject(const myObject& other13) {
...
myObject& myObject::operator=(const myObject& other14) {
  Object_Server = other14.Object_Server;
  Object_Type = other14.Object_Type;
  Object_Name = other14.Object_Name;
  Handle_ID = other14.Handle_ID;
  Resource_Attributes = other14.Resource_Attributes;
...
myProcessInformation::myProcessInformation(const myProcessInformation& other15) {
  Process_ID = other15.Process_ID;
  Process_Name = other15.Process_Name;
  __isset = other15.__isset;
}
myProcessInformation& myProcessInformation::operator=(const myProcessInformation& other16) {
  Process_ID = other16.Process_ID;
  Process_Name = other16.Process_Name;
...
myNewLogon::myNewLogon(const myNewLogon& other17) {
...
myNewLogon& myNewLogon::operator=(const myNewLogon& other18) {
  Security_ID = other18.Security_ID;
  Account_Name = other18.Account_Name;
  Account_Domain = other18.Account_Domain;
  Logon_ID = other18.Logon_ID;
  Logon_GUID = other18.Logon_GUID;
...
myNetworkInformation::myNetworkInformation(const myNetworkInformation& other19) {
...
myNetworkInformation& myNetworkInformation::operator=(const myNetworkInformation& other20) {
  Direction = other20.Direction;
  Source_Address = other20.Source_Address;
  Source_Port = other20.Source_Port;
  Destination_Address = other20.Destination_Address;
  Destination_Port = other20.Destination_Port;
  Protocol = other20.Protocol;
  Workstation_Name = other20.Workstation_Name;
...
myLogonType::myLogonType(const myLogonType& other21) {
  Logon_Type = other21.Logon_Type;
  __isset = other21.__isset;
}
myLogonType& myLogonType::operator=(const myLogonType& other22) {
  Logon_Type = other22.Logon_Type;
...
myLayerInformation::myLayerInformation(const myLayerInformation& other23) {
  Layer_ID = other23.Layer_ID;
  Layer_Name = other23.Layer_Name;
  Layer_Runtime_ID = other23.Layer_Runtime_ID;
  __isset = other23.__isset;
}
myLayerInformation& myLayerInformation::operator=(const myLayerInformation& other24) {
  Layer_ID = other24.Layer_ID;
  Layer_Name = other24.Layer_Name;
  Layer_Runtime_ID = other24.Layer_Runtime_ID;
...
myImpersonationLevel::myImpersonationLevel(const myImpersonationLevel& other25) {
  Impersonation_Level = other25.Impersonation_Level;
  __isset = other25.__isset;
}
myImpersonationLevel& myImpersonationLevel::operator=(const myImpersonationLevel& other26) {
  Impersonation_Level = other26.Impersonation_Level;
...
myFilterInformation::myFilterInformation(const myFilterInformation& other27) {
...
myFilterInformation& myFilterInformation::operator=(const myFilterInformation& other28) {
  Filter_ID = other28.Filter_ID;
  Filter_Name = other28.Filter_Name;
  Filter_Type = other28.Filter_Type;
  Runtime_ID = other28.Runtime_ID;
  Filter_Runtime_ID = other28.Filter_Runtime_ID;
  Filter_Layer_Name = other28.Filter_Layer_Name;
  Filter_Layer_Runtime_ID = other28.Filter_Layer_Runtime_ID;
...
myFailureInformation::myFailureInformation(const myFailureInformation& other29) {
  Failure_Reason = other29.Failure_Reason;
  Status = other29.Status;
  Sub_Status = other29.Sub_Status;
  __isset = other29.__isset;
}
myFailureInformation& myFailureInformation::operator=(const myFailureInformation& other30) {
  Failure_Reason = other30.Failure_Reason;
  Status = other30.Status;
  Sub_Status = other30.Sub_Status;
...
myErrorInformation::myErrorInformation(const myErrorInformation& other31) {
  Reason = other31.Reason;
  __isset = other31.__isset;
}
myErrorInformation& myErrorInformation::operator=(const myErrorInformation& other32) {
  Reason = other32.Reason;
...
myDetailedAuthenticationInformation::myDetailedAuthenticationInformation(const myDetailedAuthenticationInformation& other33) {
...
myDetailedAuthenticationInformation& myDetailedAuthenticationInformation::operator=(const myDetailedAuthenticationInformation& other34) {
  Logon_Process = other34.Logon_Process;
  Authentication_Package = other34.Authentication_Package;
  Transited_Services = other34.Transited_Services;
  Package_Name = other34.Package_Name;
  Key_Length = other34.Key_Length;
...
myChangeInformation::myChangeInformation(const myChangeInformation& other35) {
  Change_Type = other35.Change_Type;
  __isset = other35.__isset;
}
myChangeInformation& myChangeInformation::operator=(const myChangeInformation& other36) {
  Change_Type = other36.Change_Type;
...
myCalloutInformation::myCalloutInformation(const myCalloutInformation& other37) {
  Callout_ID = other37.Callout_ID;
  Callout_Name = other37.Callout_Name;
  __isset = other37.__isset;
}
myCalloutInformation& myCalloutInformation::operator=(const myCalloutInformation& other38) {
  Callout_ID = other38.Callout_ID;
  Callout_Name = other38.Callout_Name;
...
myApplicationInformation::myApplicationInformation(const myApplicationInformation& other39) {
  Application_Process_ID = other39.Application_Process_ID;
  Application_Name = other39.Application_Name;
  __isset = other39.__isset;
}
myApplicationInformation& myApplicationInformation::operator=(const myApplicationInformation& other40) {
  Application_Process_ID = other40.Application_Process_ID;
  Application_Name = other40.Application_Name;
...
myAccountForWhichLogonFailed::myAccountForWhichLogonFailed(const myAccountForWhichLogonFailed& other41) {
  Security_ID = other41.Security_ID;
  Account_Name = other41.Account_Name;
  Account_Domain = other41.Account_Domain;
  __isset = other41.__isset;
}
myAccountForWhichLogonFailed& myAccountForWhichLogonFailed::operator=(const myAccountForWhichLogonFailed& other42) {
  Security_ID = other42.Security_ID;
  Account_Name = other42.Account_Name;
  Account_Domain = other42.Account_Domain;
...
myAccessRequestInformation::myAccessRequestInformation(const myAccessRequestInformation& other43) {
...
myAccessRequestInformation& myAccessRequestInformation::operator=(const myAccessRequestInformation& other44) {
  Transaction_ID = other44.Transaction_ID;
  Accesses = other44.Accesses;
  Access_Reasons = other44.Access_Reasons;
  Access_Mask = other44.Access_Mask;
  Privileges_Used_For_Access_Check = other44.Privileges_Used_For_Access_Check;
  Restricted_SID_Count = other44.Restricted_SID_Count;
...
myTimeStamp::myTimeStamp(const myTimeStamp& other45) {
  month = other45.month;
  day = other45.day;
  year = other45.year;
  hour = other45.hour;
...
myTimeStamp& myTimeStamp::operator=(const myTimeStamp& other46) {
  month = other46.month;
  day = other46.day;
  year = other46.year;
  hour = other46.hour;
...
const char* myLogStructure::ascii_fingerprint = "5E94DF497B92961E06D4DCFD1263FDA0";
const uint8_t myLogStructure::binary_fingerprint[16] = {0x5E,0x94,0xDF,0x49,0x7B,0x92,0x96,0x1E,0x06,0xD4,0xDC,0xFD,0x12,0x63,0xFD,0xA0};
...
myLogStructure::myLogStructure(const myLogStructure& other47) {
...
myLogStructure& myLogStructure::operator=(const myLogStructure& other48) {
  message = other48.message;
  levelMessageString = other48.levelMessageString;
  taskMessageString = other48.taskMessageString;
  opCodeMessageString = other48.opCodeMessageString;
  channelMessageString = other48.channelMessageString;
  providerMessageString = other48.providerMessageString;
  keywords = other48.keywords;
  executionProcessID = other48.executionProcessID;
  executionThreadID = other48.executionThreadID;
  computer = other48.computer;
  EventID = other48.EventID;
  mySubject1 = other48.mySubject1;
  myProviderInformation1 = other48.myProviderInformation1;
  myObject1 = other48.myObject1;
  myNetworkInformation1 = other48.myNetworkInformation1;
  myLayerInformation1 = other48.myLayerInformation1;
  myFilterInformation1 = other48.myFilterInformation1;
  myChangeInformation1 = other48.myChangeInformation1;
  myCalloutInformation1 = other48.myCalloutInformation1;
  myApplicationInformation1 = other48.myApplicationInformation1;
  myAccessRequestInformation1 = other48.myAccessRequestInformation1;
  myRuleInformation1 = other48.myRuleInformation1;
  myErrorInformation1 = other48.myErrorInformation1;
  myProcessInformation1 = other48.myProcessInformation1;
  myLogonType1 = other48.myLogonType1;
  myImpersonationLevel1 = other48.myImpersonationLevel1;
  myAccountForWhichLogonFailed1 = other48.myAccountForWhichLogonFailed1;
  myFailureInformation1 = other48.myFailureInformation1;
  myNewLogon1 = other48.myNewLogon1;
  myDetailedAuthenticationInformation1 = other48.myDetailedAuthenticationInformation1;
  myTimeStamp1 = other48.myTimeStamp1;
  mac = other48.mac;
